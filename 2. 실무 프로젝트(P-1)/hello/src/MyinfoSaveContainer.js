...
import { apiUser, save } from '../apis/apiMyinfo';
...
const MyInfoSaveContainer = () => {
  ...
  const onSubmit = useCallback(
    (e) => {
      ...
      (async () => {
        try {
          const { locationAfterWriting, email } = form;
          const res = form.mode === 'save' ? await save(email, form) : [];
